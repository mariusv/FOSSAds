...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('ads_product', (
            ('id', orm['ads.product:id']),
            ('name', orm['ads.product:name']),
            ('advertiser', orm['ads.product:advertiser']),
        ))
        db.send_create_signal('ads', ['Product'])
        
        # Adding field 'Ad.product'
        db.add_column('ads_ad', 'product', orm['ads.ad:product'])
        
        # Deleting field 'Ad.advertiser'
        db.delete_column('ads_ad', 'advertiser_id')
    ...
    def backwards(self, orm):
        ...
        db.delete_table('ads_product')
        
        # Deleting field 'Ad.product'
        db.delete_column('ads_ad', 'product_id')
        
        # Adding field 'Ad.advertiser'
        db.add_column('ads_ad', 'advertiser', orm['ads.ad:advertiser'])
